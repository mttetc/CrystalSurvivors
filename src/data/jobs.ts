import { JobId, JobSkillId, MasterySkillId, Rarity, SkillFamily, SPRITE_SCALE } from '../constants';
...
export const JOB_DEFS: Record<JobId, JobDef> = {
  ...
  [JobId.SUMMONER]: {
    ...
    icon: 'job_summoner',
    skills: [
      JobSkillId.IFRIT, JobSkillId.SHIVA, JobSkillId.RAMUH,
      JobSkillId.TITAN, JobSkillId.CARBUNCLE, JobSkillId.LEVIATHAN,
      JobSkillId.ODIN, JobSkillId.ALEXANDER, JobSkillId.BAHAMUT,
      JobSkillId.DIABOLOS, JobSkillId.KNIGHTS_OF_THE_ROUND,
    ],
    masterySkills: [MasterySkillId.PHOENIX, MasterySkillId.DREADWYRM, MasterySkillId.EDEN],
    passive: {
      name: 'Empathy',
      tiers: [
        {
          description: '+20% summon damage, -15% summon cooldowns',
          apply: (mods: PlayerStatModifiers) => { mods.summonFamilyDamage += 0.20; mods.summonFamilyCooldown += 0.15; },
        },
        {
          description: '+35% summon damage, -30% summon cooldowns',
          apply: (mods: PlayerStatModifiers) => { mods.summonFamilyDamage += 0.35; mods.summonFamilyCooldown += 0.30; },
        },
      ],
    },
  },
...
export const JOB_SKILL_DEFS: Record<JobSkillId, JobSkillDef> = {
  ...
  [JobSkillId.IFRIT]: {
    ...
    levels: [
      {
        description: 'Fire familiar orbiting, 4 dmg per hit (1.5s interval)',
        params: { damage: 4, attackInterval: 1500 },
      },
      {
        description: 'Fire familiar orbiting, 8 dmg per hit (1.2s interval)',
        params: { damage: 8, attackInterval: 1200 },
      },
      {
        description: 'Fire familiar orbiting, 14 dmg per hit (0.9s interval)',
        params: { damage: 14, attackInterval: 900 },
      },
      {
        description: 'Fire familiar orbiting, 21 dmg per hit (0.7s interval)',
        params: { damage: 21, attackInterval: 700 },
      },
      {
        description: 'Fire familiar orbiting, 30 dmg per hit (0.55s interval)',
        params: { damage: 30, attackInterval: 550 },
      },
      {
        description: 'Fire familiar orbiting, 42 dmg per hit (0.4s interval)',
        params: { damage: 42, attackInterval: 400 },
      },
    ],
  },
  [JobSkillId.SHIVA]: {
  ...
  [JobSkillId.BAHAMUT]: {
    ...
    levels: [
      {
        description: 'Mega Flare laser 30x400px dealing 15 dmg (12s CD)',
        params: { beamWidth: 30, beamLength: 400, damage: 15, cooldown: 12000 },
      },
      {
        description: 'Mega Flare laser 30x400px dealing 26 dmg (9s CD)',
        params: { beamWidth: 30, beamLength: 400, damage: 26, cooldown: 9000 },
      },
      {
        description: 'Mega Flare laser 30x400px dealing 42 dmg (6s CD)',
        params: { beamWidth: 30, beamLength: 400, damage: 42, cooldown: 6000 },
      },
      {
        description: 'Mega Flare laser 30x400px dealing 59 dmg (5s CD)',
        params: { beamWidth: 30, beamLength: 400, damage: 59, cooldown: 5000 },
      },
      {
        description: 'Mega Flare laser 30x400px dealing 79 dmg (4s CD)',
        params: { beamWidth: 30, beamLength: 400, damage: 79, cooldown: 4000 },
      },
      {
        description: 'Mega Flare laser 30x400px dealing 104 dmg (3s CD)',
        params: { beamWidth: 30, beamLength: 400, damage: 104, cooldown: 3000 },
      },
    ],
  },
  ...
  [JobSkillId.RAMUH]: {
    ...
    levels: [
      { description: 'Judgment Bolt AoE 70px dealing 12 dmg (10s CD)', params: { radius: 70 * SS, damage: 12, cooldown: 10000 } },
      { description: 'Judgment Bolt AoE 85px dealing 20 dmg (8s CD)', params: { radius: 85 * SS, damage: 20, cooldown: 8000 } },
      { description: 'Judgment Bolt AoE 100px dealing 32 dmg (6s CD)', params: { radius: 100 * SS, damage: 32, cooldown: 6000 } },
      { description: 'Judgment Bolt AoE 115px dealing 45 dmg (5s CD)', params: { radius: 115 * SS, damage: 45, cooldown: 5000 } },
      { description: 'Judgment Bolt AoE 130px dealing 60 dmg (4s CD)', params: { radius: 130 * SS, damage: 60, cooldown: 4000 } },
      { description: 'Judgment Bolt AoE 145px dealing 80 dmg (3s CD)', params: { radius: 145 * SS, damage: 80, cooldown: 3000 } },
    ],
  },
  [JobSkillId.TITAN]: {
    id: JobSkillId.TITAN,
    ...
    minRarity: Rarity.RARE,
    levels: [
      { description: 'Earthen Fury AoE 75px dealing 14 dmg + stun (10s CD)', params: { radius: 75 * SS, damage: 14, stunDuration: 500, cooldown: 10000 } },
      { description: 'Earthen Fury AoE 90px dealing 22 dmg + stun (8s CD)', params: { radius: 90 * SS, damage: 22, stunDuration: 600, cooldown: 8000 } },
      { description: 'Earthen Fury AoE 105px dealing 35 dmg + stun (6s CD)', params: { radius: 105 * SS, damage: 35, stunDuration: 700, cooldown: 6000 } },
      { description: 'Earthen Fury AoE 120px dealing 48 dmg + stun (5s CD)', params: { radius: 120 * SS, damage: 48, stunDuration: 800, cooldown: 5000 } },
      { description: 'Earthen Fury AoE 135px dealing 65 dmg + stun (4s CD)', params: { radius: 135 * SS, damage: 65, stunDuration: 900, cooldown: 4000 } },
      { description: 'Earthen Fury AoE 150px dealing 85 dmg + stun (3s CD)', params: { radius: 150 * SS, damage: 85, stunDuration: 1000, cooldown: 3000 } },
    ],
  },
  [JobSkillId.CARBUNCLE]: {
    id: JobSkillId.CARBUNCLE,
    jobId: JobId.SUMMONER,
    name: 'Carbuncle',
    type: 'modifier',
    family: SkillFamily.SUPPORT,
    minRarity: Rarity.RARE,
    levels: [
      { description: 'Ruby Light: +2 armor, 5% damage reflect', apply: (mods: PlayerStatModifiers) => { mods.armor += 2; mods.damageReflect += 0.05; } },
      { description: 'Ruby Light: +3 armor, 8% damage reflect', apply: (mods: PlayerStatModifiers) => { mods.armor += 3; mods.damageReflect += 0.08; } },
      { description: 'Ruby Light: +4 armor, 12% damage reflect', apply: (mods: PlayerStatModifiers) => { mods.armor += 4; mods.damageReflect += 0.12; } },
      { description: 'Ruby Light: +5 armor, 16% damage reflect', apply: (mods: PlayerStatModifiers) => { mods.armor += 5; mods.damageReflect += 0.16; } },
      { description: 'Ruby Light: +7 armor, 20% damage reflect', apply: (mods: PlayerStatModifiers) => { mods.armor += 7; mods.damageReflect += 0.20; } },
      { description: 'Ruby Light: +9 armor, 25% damage reflect', apply: (mods: PlayerStatModifiers) => { mods.armor += 9; mods.damageReflect += 0.25; } },
    ],
  },
  [JobSkillId.LEVIATHAN]: {
    id: JobSkillId.LEVIATHAN,
    jobId: JobId.SUMMONER,
    name: 'Leviathan',
    type: 'active',
    family: SkillFamily.MAGIC,
    ...
    levels: [
      { description: 'Tidal Wave AoE 90px dealing 18 dmg + push (9s CD)', params: { radius: 90 * SS, damage: 18, knockback: 1, cooldown: 9000 } },
      { description: 'Tidal Wave AoE 110px dealing 30 dmg + push (7s CD)', params: { radius: 110 * SS, damage: 30, knockback: 1, cooldown: 7000 } },
      { description: 'Tidal Wave AoE 130px dealing 45 dmg + push (5.5s CD)', params: { radius: 130 * SS, damage: 45, knockback: 1, cooldown: 5500 } },
      { description: 'Tidal Wave AoE 145px dealing 62 dmg + push (4.5s CD)', params: { radius: 145 * SS, damage: 62, knockback: 1, cooldown: 4500 } },
      { description: 'Tidal Wave AoE 160px dealing 82 dmg + push (3.5s CD)', params: { radius: 160 * SS, damage: 82, knockback: 1, cooldown: 3500 } },
      { description: 'Tidal Wave AoE 180px dealing 105 dmg + push (3s CD)', params: { radius: 180 * SS, damage: 105, knockback: 1, cooldown: 3000 } },
    ],
  },
  [JobSkillId.ODIN]: {
    id: JobSkillId.ODIN,
    ...
    minRarity: Rarity.EPIC,
    levels: [
      { description: 'Zantetsuken line slash, 25 dmg, 10% execute <20% HP (10s CD)', params: { radius: 100 * SS, damage: 25, executeThreshold: 0.20, cooldown: 10000 } },
      { description: 'Zantetsuken line slash, 40 dmg, 12% execute <20% HP (8s CD)', params: { radius: 120 * SS, damage: 40, executeThreshold: 0.20, cooldown: 8000 } },
      { description: 'Zantetsuken line slash, 55 dmg, 15% execute <25% HP (6s CD)', params: { radius: 140 * SS, damage: 55, executeThreshold: 0.25, cooldown: 6000 } },
      { description: 'Zantetsuken line slash, 72 dmg, 18% execute <25% HP (5s CD)', params: { radius: 150 * SS, damage: 72, executeThreshold: 0.25, cooldown: 5000 } },
      { description: 'Zantetsuken line slash, 92 dmg, 22% execute <30% HP (4s CD)', params: { radius: 160 * SS, damage: 92, executeThreshold: 0.30, cooldown: 4000 } },
      { description: 'Zantetsuken line slash, 115 dmg, 25% execute <30% HP (3s CD)', params: { radius: 170 * SS, damage: 115, executeThreshold: 0.30, cooldown: 3000 } },
    ],
  },
  [JobSkillId.ALEXANDER]: {
    id: JobSkillId.ALEXANDER,
    jobId: JobId.SUMMONER,
    name: 'Alexander',
    type: 'active',
    family: SkillFamily.MAGIC,
    minRarity: Rarity.EPIC,
    levels: [
      { description: 'Divine Judgment laser 25x350px dealing 20 dmg (10s CD)', params: { beamWidth: 25, beamLength: 350, damage: 20, cooldown: 10000 } },
      { description: 'Divine Judgment laser 25x350px dealing 34 dmg (8s CD)', params: { beamWidth: 25, beamLength: 350, damage: 34, cooldown: 8000 } },
      { description: 'Divine Judgment laser 25x350px dealing 50 dmg (6s CD)', params: { beamWidth: 25, beamLength: 350, damage: 50, cooldown: 6000 } },
      { description: 'Divine Judgment laser 25x350px dealing 68 dmg (5s CD)', params: { beamWidth: 25, beamLength: 350, damage: 68, cooldown: 5000 } },
      { description: 'Divine Judgment laser 25x350px dealing 88 dmg (4s CD)', params: { beamWidth: 25, beamLength: 350, damage: 88, cooldown: 4000 } },
      { description: 'Divine Judgment laser 25x350px dealing 112 dmg (3s CD)', params: { beamWidth: 25, beamLength: 350, damage: 112, cooldown: 3000 } },
    ],
  },
  [JobSkillId.DIABOLOS]: {
    id: JobSkillId.DIABOLOS,
    jobId: JobId.SUMMONER,
    name: 'Diabolos',
    type: 'active',
    family: SkillFamily.MAGIC,
    minRarity: Rarity.LEGENDARY,
    levels: [
      { description: 'Dark Messenger gravity sphere 70px, 5% max HP dmg (12s CD)', params: { radius: 70 * SS, damage: 15, maxHpPercent: 0.05, cooldown: 12000 } },
      { description: 'Dark Messenger gravity sphere 85px, 7% max HP dmg (10s CD)', params: { radius: 85 * SS, damage: 22, maxHpPercent: 0.07, cooldown: 10000 } },
      { description: 'Dark Messenger gravity sphere 100px, 9% max HP dmg (8s CD)', params: { radius: 100 * SS, damage: 32, maxHpPercent: 0.09, cooldown: 8000 } },
      { description: 'Dark Messenger gravity sphere 115px, 11% max HP dmg (6s CD)', params: { radius: 115 * SS, damage: 44, maxHpPercent: 0.11, cooldown: 6000 } },
      { description: 'Dark Messenger gravity sphere 130px, 13% max HP dmg (5s CD)', params: { radius: 130 * SS, damage: 58, maxHpPercent: 0.13, cooldown: 5000 } },
      { description: 'Dark Messenger gravity sphere 145px, 15% max HP dmg (4s CD)', params: { radius: 145 * SS, damage: 75, maxHpPercent: 0.15, cooldown: 4000 } },
    ],
  },
  [JobSkillId.KNIGHTS_OF_THE_ROUND]: {
    id: JobSkillId.KNIGHTS_OF_THE_ROUND,
    jobId: JobId.SUMMONER,
    ...
    levels: [
      { description: 'Ultimate End: 13 strikes in circle, 8 dmg each (15s CD)', params: { radius: 120 * SS, strikeCount: 13, damage: 8, cooldown: 15000 } },
      { description: 'Ultimate End: 13 strikes in circle, 14 dmg each (12s CD)', params: { radius: 135 * SS, strikeCount: 13, damage: 14, cooldown: 12000 } },
      { description: 'Ultimate End: 13 strikes in circle, 22 dmg each (9s CD)', params: { radius: 150 * SS, strikeCount: 13, damage: 22, cooldown: 9000 } },
      { description: 'Ultimate End: 13 strikes in circle, 32 dmg each (7s CD)', params: { radius: 165 * SS, strikeCount: 13, damage: 32, cooldown: 7000 } },
      { description: 'Ultimate End: 13 strikes in circle, 44 dmg each (5.5s CD)', params: { radius: 180 * SS, strikeCount: 13, damage: 44, cooldown: 5500 } },
      { description: 'Ultimate End: 13 strikes in circle, 60 dmg each (4s CD)', params: { radius: 200 * SS, strikeCount: 13, damage: 60, cooldown: 4000 } },
    ],
  },
...
export const MASTERY_SKILL_DEFS: Record<MasterySkillId, JobSkillDef> = {
  ...
  [MasterySkillId.PHOENIX]: {
    ...
    family: SkillFamily.SUMMONING,
    levels: [
      { description: 'Fire familiar + heal 2 HP/s while alive', params: { damage: 6, healPerSecond: 2, attackInterval: 1200 } },
      { description: 'Fire familiar + heal 3 HP/s while alive', params: { damage: 11, healPerSecond: 3, attackInterval: 1000 } },
      { description: 'Fire familiar + heal 5 HP/s while alive', params: { damage: 17, healPerSecond: 5, attackInterval: 800 } },
      { description: 'Fire familiar + heal 7 HP/s while alive', params: { damage: 24, healPerSecond: 7, attackInterval: 650 } },
      { description: 'Fire familiar + heal 10 HP/s while alive', params: { damage: 33, healPerSecond: 10, attackInterval: 500 } },
      { description: 'Fire familiar + heal 14 HP/s while alive', params: { damage: 45, healPerSecond: 14, attackInterval: 400 } },
    ],
  },
  [MasterySkillId.DREADWYRM]: {
    ...
    family: SkillFamily.MAGIC,
    levels: [
      { description: 'Dark AoE 90px dealing 23 dmg (10s CD)', params: { radius: 90 * SS, damage: 23, cooldown: 10000 } },
      { description: 'Dark AoE 110px dealing 38 dmg (8s CD)', params: { radius: 110 * SS, damage: 38, cooldown: 8000 } },
      { description: 'Dark AoE 130px dealing 56 dmg (6s CD)', params: { radius: 130 * SS, damage: 56, cooldown: 6000 } },
      { description: 'Dark AoE 150px dealing 79 dmg (5s CD)', params: { radius: 150 * SS, damage: 79, cooldown: 5000 } },
      { description: 'Dark AoE 170px dealing 105 dmg (4s CD)', params: { radius: 170 * SS, damage: 105, cooldown: 4000 } },
      { description: 'Dark AoE 190px dealing 135 dmg (3s CD)', params: { radius: 190 * SS, damage: 135, cooldown: 3000 } },
    ],
  },
  [MasterySkillId.EDEN]: {
    id: MasterySkillId.EDEN,
    jobId: JobId.SUMMONER,
    name: 'Eden',
    type: 'active',
    family: SkillFamily.MAGIC,
    minRarity: Rarity.MYTHIC,
    levels: [
      { description: 'Eternal Breath screen-wide pulse 200px, 35 dmg (15s CD)', params: { radius: 200 * SS, damage: 35, cooldown: 15000 } },
      { description: 'Eternal Breath screen-wide pulse 230px, 55 dmg (12s CD)', params: { radius: 230 * SS, damage: 55, cooldown: 12000 } },
      { description: 'Eternal Breath screen-wide pulse 260px, 80 dmg (9s CD)', params: { radius: 260 * SS, damage: 80, cooldown: 9000 } },
      { description: 'Eternal Breath screen-wide pulse 290px, 110 dmg (7s CD)', params: { radius: 290 * SS, damage: 110, cooldown: 7000 } },
      { description: 'Eternal Breath screen-wide pulse 320px, 145 dmg (5.5s CD)', params: { radius: 320 * SS, damage: 145, cooldown: 5500 } },
      { description: 'Eternal Breath screen-wide pulse 350px, 185 dmg (4s CD)', params: { radius: 350 * SS, damage: 185, cooldown: 4000 } },
    ],
  },
  // ═══ TIME MAGE ═══
